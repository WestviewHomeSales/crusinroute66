...
export const states: State[] = [
  {
    ...
    attractions: [
      ...
      // Williamsville
      {
        ...
        name: 'Historic Downtown with Route 66 signs',
      ...
      },
      {
        ...
        name: 'Abraham Lincoln Presidential Library & Museum',
      ...
      {
        id: 'route66-motorheads-bar-grill',
        name: 'Route 66 Motorheads Bar & Grill & Museum',
      ...
      // Carlinville
      {
        id: 'historic-downtown-square-carlinville',
      ...
      // Hamel / Edwardsville
      {
        ...
        name: "Weezy's Route 66 Bar & Grill (Hamel)",
      ...
      {
        id: 'route66-mural-edwardsville',
        name: 'Route 66 Mural (Edwardsville)',
      ...
      },
      {
        ...
        coordinates: { lat: 38.76644, lng: -90.18083 },
        address: '10950 Riverview Dr, St. Louis, MO 63137',
        type: 'ruins',
  ...
  },
  {
    ...
    attractions: [
      ...
      // St. Clair
      {
        id: 'visitor-center-roadhouse',
        name: 'Visitor Center in a restored 1935 roadhouse',
      ...
      },
      {
        ...
        name: 'River overlook, nature trails, and classic signs',
      ...
      // Cuba
      {
        ...
        name: '"Route 66 Mural City" outdoor wall art',
      ...
      },
      {
        ...
        name: "Devil's Elbow Bridge (historic dog-leg bridge)",
      ...
      // Springfield
      {
        ...
        name: 'Route 66 Springfield Visitor Center',
      ...
      {
        id: 'garys-gay-parita',
        name: "Gary's Gay Parita Sinclair Gas Station",
      ...
      // Carthage
      {
        ...
        name: 'Boots Court Motel (restored 1939 motor court)',
      ...
      },
      {
        ...
        name: 'Route 66 Mural Park in Joplin',
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        name: 'Downtown Edmond Statues, Murals & Diners',
      ...
      // Elk City
      {
        id: 'national-route66-museum-complex',
        name: 'National Route 66 Museum Complex',
      ...
      {
        id: 'sayre-city-hall',
        name: 'Sayre City Hall / Courthouse',
      ...
      },
      {
        ...
        name: 'Historic Beckham County Courthouse',
      ...
      // Erick
      {
        ...
        description: 'Legendary duo Harley & Annabelle (now closed, but building still photo-worthy), a Route 66 institution.',
      ...
      },
      {
        ...
        name: 'Downtown Erick Vintage Murals',
  ...
  },
  {
    ...
    attractions: [
      ...
      {
        id: 'little-juarez-cafe-state-line-bar',
        name: 'Little Juarez Café & State Line Bar',
  ...
  },
  {
    ...
    attractions: [
      ...
      },
      {
        ...
        coordinates: { lat: 34.9398, lng: -104.6789 },
        address: '2866 Route 66, Santa Rosa, NM 88435',
        type: 'museum',
      ...
      },
      {
        ...
        coordinates: { lat: 34.9398, lng: -104.6789 },
        address: '3701 Route 66, Santa Rosa, NM 88435',
        type: 'food',
      ...
      },
      {
        ...
        name: 'Classic motels and churches',
  ...
  },
  {
    ...
    attractions: [
      ...
      // Sanders / Chambers
      {
        id: 'historic-trading-posts-sanders',
        name: 'Historic Trading Posts',
        description: 'Old, faded signs and abandoned buildings representing the golden age of Route 66 commerce.',
        coordinates: { lat: 35.2181, lng: -109.3226 },
        address: 'Old Route 66, Sanders, AZ 86512',
        type: 'historic',
        image: 'https://images.pexels.com/photos/1563356/pexels-photo-1563356.jpeg?auto=compress&cs=tinysrgb&w=800'
      },
      ...
      {
        id: 'historic-navajo-county-courthouse',
        name: 'Historic Navajo County Courthouse & Museum',
      ...
      {
        id: 'meteor-crater-winslow',
        name: 'Meteor Crater (nearby)',
      ...
      },
      {
        ...
        name: "Ella's Frontier Trading Post (ruins)",
      ...
      },
      {
        ...
        name: 'Buffalo Park / Mt. Elden views',
      ...
      {
        id: 'ruins-old-motels-gas-stations',
        name: 'Ruins of old motels and gas stations',
        description: 'Classic Route 66 decay showcasing the abandoned infrastructure of America\'s most famous highway.',
        coordinates: { lat: 35.2283, lng: -111.8513 },
        address: 'Old Route 66, Bellemont, AZ 86015',
        type: 'historic',
        image: 'https://images.pexels.com/photos/1563356/pexels-photo-1563356.jpeg?auto=compress&cs=tinysrgb&w=800'
      ...
      {
        id: 'petes-gas-station-museum',
        name: "Pete's Gas Station Museum",
      ...
      {
        id: 'grand-canyon-railway-hotel',
        name: 'Grand Canyon Railway Hotel & Depot',
      ...
      {
        id: 'grand-canyon-national-park-side-trip',
        name: 'Grand Canyon National Park (side trip)',
      ...
      // Ash Fork
      {
        ...
        name: 'Route 66 Museum at the Ash Fork Library',
      ...
      // Seligman
      {
        id: 'delgadillos-snow-cap-drive-in',
      ...
      {
        id: 'angel-delgadillo-barbershop',
        name: "Angel Delgadillo's Barbershop & Gift Shop",
      ...
      },
      {
        ...
        name: 'Classic cars & murals everywhere',
      ...
      {
        id: 'old-gas-station-ruins-peach-springs',
        name: 'Old gas station ruins',
      ...
      // Truxton / Valentine
      {
        id: 'truxton-motel-ruins',
        name: 'Truxton Motel (ruins)',
      ...
      {
        id: 'cool-springs',
        name: 'Cool Springs (west of town)',
