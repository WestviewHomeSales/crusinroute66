...
const StatePage: React.FC<StatePageProps> = ({ state, onBack }) => {
  ...
  const formatCoordinates = (lat: number, lng: number) => {
    ...
    const lngDecimals = lngStr.includes('.') ? latStr.split('.')[1].length : 0;
            ...
            return (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mb-3">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getTypeColor(attraction.type)}`}>
